            ...
            <div className={`flex-1 ${styles.flexStart} flex flex-col xl:px-0 sm:px-16 px-6`}>
                ...
                <div className="flex flex-col">
                    <div className="flex flex-row justify-between items-center w-full">
                        <h1 className="flex-1 font-poppins font-semibold ss:text-6xl text-[48px] text-white ss:leading-[100px] leading-[75px]">
                    ...
                    <h1 className="font-poppins font-semibold ss:text-6xl text-[48px] text-white ss:leading-[100px] leading-[75px] w-full">
                        Payment Method.
                    </h1>
